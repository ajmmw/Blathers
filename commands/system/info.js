...
exports.run = (client, message, args) => {
	/* - Dynamic version grabbing - */
	let rawdata = fs.readFileSync('package.json'); //yes this works, fs is weird asf
	...
	const embed = new Discord.MessageEmbed()
		...
		.addField(
			`Invite`,
			`[Click Here](https://discordapp.com/api/oauth2/authorize?client_id=598007871720128544&permissions=387072&scope=bot)`, //more readable :)
			true
		)
